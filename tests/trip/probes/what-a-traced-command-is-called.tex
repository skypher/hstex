...
% atom of its own and every one is traced: `\hbox{abc}' draws three lines
% and so does `$abc$'. hstex drew three for the first and one for the
% second.
%
...
\sk=1pt
\let\pp=\par \pp
\message{[a run in horizontal mode and in math mode]}
\hbox{abc}
\setbox9=\hbox{$abc$}
\setbox9=\hbox{$123$}
\tracingcommands=0
