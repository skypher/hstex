...
static int test_showbox(void)
{
    ...
    static const char *const expected[] = {
        ...
        "e 0.0 plus 2.0fil\n\n! OK.\n> \\box0=\n\\hbox(6.83"
        "331+2.0)x30.0, glue set 0.48332\n.\\glue 10.0 plus"
        " 5.0 minus 2.0\n.\\f A\n.\\f B\n.\\kern 3.0\n.\\hb"
        "ox(0.0+0.0)x0.0, shifted 2.0\n\n! OK.\n> \\box0=\n"
        "\\vbox(40.0+0.0)x7.50002, glue set 15.16669fill\n."
        "\\rule(2.0+0.0)x*\n.\\glue 4.0 plus 1.0fill\n.\\hb"
        "ox(6.83331+0.0)x7.50002\n..\\f A\n.\\penalty 150\n"
        ".\\glue(\\baselineskip) 12.0\n.\\hbox(0.0+0.0)x0.0"
        ", shifted 3.0\n\n! OK.\n> \\box0=\n\\hbox(0.0+0.0)"
        "x5.0\n.\\glue 0.0 minus 1.0\n.\\glue 0.0 minus 3.0"
        "\n\n! OK.\n> \\box0=\n\\hbox(1.0+0.0)x20.0, glue s"
        "et 20.0fil\n.\\leaders 0.0 plus 1.0fil\n..\\hbox(1"
        ".0+0.0)x2.0\n...\\rule(1.0+*)x2.0\n\n! OK.\n> \\bo"
        "x0=\n\\hbox(0.0+0.0)x5.0, glue set - 1.0\n.\\glue "
        "20.0 minus 3.0\n\n! OK.\n> \\box0=\n\\hbox(0.0+0.0"
        ")x5.0, glue set - 15.0fil\n.\\glue 20.0 minus 1.0f"
...
static int test_paragraph_display(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n> \\box0=\n\\vbox(42.944"
        "44+0.0)x180.0\n.\\hbox(6.94444+1.94444)x180.0, glu"
        "e set 0.12775\n..\\hbox(0.0+0.0)x20.0\n..\\f T\n.."
        ...
        ".94444)x180.0, glue set - 0.43933\n..\\f l\n..\\f "
        "a\n..\\f z\n..\\f y\n..\\glue 3.33333 plus 1.66666"
        " minus 1.11111\n..\\f d\n..\\f o\n..\\f g\n..\\glu"
        "e 3.33333 plus 1.66666 minus 1.11111\n..\\f a\n.."
        "\\f n\n..\\f d\n..\\glue 3.33333 plus 1.66666 minu"
        "s 1.11111\n..\\f t\n..\\f h\n..\\f e\n..\\f n\n.."
        "\\glue 3.33333 plus 1.66666 minus 1.11111\n..\\f r"
        "\n..\\f u\n..\\f n\n..\\f s\n..\\f a\n..\\kern-0.2"
        "7779\n..\\f w\n..\\kern-0.27779\n..\\f a\n..\\kern"
        "-0.27779\n..\\f y\n..\\glue 3.33333 plus 1.66666 m"
        "inus 1.11111\n..\\f i\n..\\f n\n..\\kern-0.27779\n"
        ...
        "1111\n..\\f n\n..\\f o\n..\\f b\n..\\kern0.27779\n"
        "..\\f o\n..\\kern0.27779\n..\\f d\n..\\f y\n..\\gl"
        "ue 3.33333 plus 1.66666 minus 1.11111\n..\\f c\n.."
        "\\f a\n..\\f n\n..\\glue 3.33333 plus 1.66666 minu"
        "s 1.11111\n..\\f ^^L (ligature fi)\n..\\f n\n..\\f"
        " d\n..\\glue 3.33333 plus 1.66666 minus 1.11111\n."
        ".\\f h\n..\\f i\n..\\f m\n..\\glue 3.33333 plus 1."
        "66666 minus 1.11111\n..\\f a\n..\\f t\n..\\glue(\\"
        "rightskip) 0.0\n.\\penalty 150\n.\\glue(\\baseline"
        "skip) 3.11111\n.\\hbox(6.94444+0.0)x180.0, glue se"
        "t 166.66663fil\n..\\f a\n..\\f l\n..\\f l\n..\\f ."
...
static int test_output_routine(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[1|20.0pt|50.0pt|0] [2|4"
        "1.0pt|50.0pt|0] [3|62.0pt|50.0pt|0]\n[OUT|10000|1|"
        "50.0pt|1.0pt|4.0pt|10000|50.0pt|62.0pt] [0] [4|41."
        "0pt|50.0pt|0]\n[OUT|-10000|1|50.0pt|1.0pt|4.0pt|10"
        "000|50.0pt|41.0pt] [0]\n[5|0.0pt|16383.99998pt|0] "
        "[6|20.0pt|50.0pt|0] [end|50.0pt|20.0pt|0]\n[OUT|-1"
        "073741824|1|50.0pt|0.0pt|100.0pt|0|50.0pt|21.0pt] "
        "[0]",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_page_totals(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[1|16383.99998pt|0.0pt|0"
        ".0pt|0.0pt|0.0pt|0.0pt|0.0pt]\n[2|16383.99998pt|0."
        "0pt|0.0pt|0.0pt|0.0pt|0.0pt|0.0pt]\n[3|16383.99998"
        "pt|0.0pt|0.0pt|0.0pt|0.0pt|0.0pt|0.0pt]\n[4|16383."
        "99998pt|0.0pt|0.0pt|0.0pt|0.0pt|0.0pt|0.0pt]\n[5|2"
        "00.0pt|21.0pt|2.0pt|3.0pt|4.0pt|0.0pt|0.0pt]\n[6|2"
        "00.0pt|21.0pt|2.0pt|3.0pt|4.0pt|0.0pt|0.0pt]\n[7|2"
        "00.0pt|21.0pt|2.0pt|3.0pt|4.0pt|0.0pt|0.0pt]\n[8|2"
        "00.0pt|21.0pt|2.0pt|3.0pt|4.0pt|0.0pt|0.0pt]\n[9|2"
        "00.0pt|36.0pt|0.0pt|3.0pt|4.0pt|1.0pt|0.0pt]\n[10|"
        "200.0pt|48.0pt|0.0pt|3.0pt|4.0pt|1.0pt|1.0pt]\n[11"
        "|200.0pt|60.0pt|0.0pt|3.0pt|4.0pt|1.0pt|1.0pt]\n[1"
        "2|200.0pt|72.0pt|1.0pt|3.0pt|4.0pt|1.0pt|1.0pt]\n>"
        " \\box254=void\n\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_discretionaries(void)
{
    ...
    static const char *const expected[] = {
        ...
        "0.0, glue set 5.5555fil\n..\\f c\n..\\f a\n..\\f a"
        "\n..\\f a\n..\\f a\n..\\penalty 10000\n..\\glue(\\"
        "parfillskip) 0.0 plus 1.0fil\n..\\glue(\\rightskip"
        ") 0.0\n\n! OK.\n> \\box0=\n\\vbox(16.30554+0.0)x30"
        ".0\n.\\hbox(4.30554+0.0)x30.0\n..\\f a\n..\\f a\n."
        ".\\f a\n..\\f a\n..\\discretionary\n..\\glue(\\rig"
        "htskip) 0.0\n.\\penalty 77\n.\\glue(\\baselineskip"
        ") 7.69446\n.\\hbox(4.30554+0.0)x30.0, glue set 9.9"
        "9994fil\n..\\f a\n..\\f a\n..\\f a\n..\\f a\n..\\p"
...
static int test_parskip_in_the_outermost_list(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n> \\box255=\n\\vbox(200."
        "0+0.0)x100.0, glue set 173.0\n.\\glue(\\topskip) 0"
        ".0\n.\\hbox(0.0+0.0)x0.0\n.\\glue(\\baselineskip) "
        "12.0\n.\\hbox(0.0+0.0)x0.0\n.\\glue(\\parskip) 3.0"
        " plus 1.0\n.\\glue(\\baselineskip) 5.16669\n.\\hbo"
        "x(6.83331+0.0)x100.0, glue set 92.49998fil []\n\n!"
        " OK.\n[0]\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_character_protrusion(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[ragged]\n> \\box1=\n\\v"
        "box(6.83331+0.0)x40.0\n.\\hbox(6.83331+0.0)x40.0, "
        "glue set 14.20831fil\n..\\kern-1.0 (left margin)\n"
        "..\\f A\n..\\f B\n..\\penalty 10000\n..\\kern-2.0 "
        "(right margin)\n..\\glue(\\parfillskip) 0.0 plus 1"
        ".0fil\n..\\glue(\\rightskip) 0.0 plus 1.0fil\n\n! "
        "OK.\n[emptybox]\n> \\box1=\n\\vbox(6.83331+0.0)x40"
        ".0\n.\\hbox(6.83331+0.0)x40.0, glue set 28.41663fi"
        "l\n..\\kern-1.0 (left margin)\n..\\hbox(0.0+0.0)x0"
        ".0\n..\\f A\n..\\f B\n..\\penalty 10000\n..\\kern-"
        "2.0 (right margin)\n..\\glue(\\parfillskip) 0.0 pl"
        "us 1.0fil\n..\\glue(\\rightskip) 0.0\n\n! OK.\n[fu"
        "llbox]\n> \\box1=\n\\vbox(6.83331+0.0)x40.0\n.\\hb"
        "ox(6.83331+0.0)x40.0, glue set 27.41663fil\n..\\hb"
        ...
        "\\glue(\\rightskip) 0.0\n\n! OK.\n[zeroglue]\n> \\"
        "box1=\n\\vbox(6.83331+0.0)x40.0\n.\\hbox(6.83331+0"
        ".0)x40.0, glue set 27.41663fil\n..\\glue 0.0\n..\\"
        "f A\n..\\f B\n..\\penalty 10000\n..\\kern-2.0 (rig"
        "ht margin)\n..\\glue(\\parfillskip) 0.0 plus 1.0fi"
        "l\n..\\glue(\\rightskip) 0.0\n\n! OK.\n> \\box254="
        "void\n\n! OK.\n",
        NULL,
    };
...
static int test_the_discretionary_after_an_explicit_hyphen(void)
{
    ...
    static const char *const hyphen_expected[] = {
        ...
        "0.0\n.\\hbox(6.94444+0.0)x200.0, glue set 186.1110"
        "8fil\n..\\f a\n..\\f -\n..\\f b\n..\\penalty 10000"
        "\n..\\glue(\\parfillskip) 0.0 plus 1.0fil\n..\\glu"
        "e(\\rightskip) 0.0\n\n! OK.\n[C]\n> \\box0=\n\\vbo"
        "x(6.94444+0.0)x200.0\n.\\hbox(6.94444+0.0)x200.0, "
        "glue set 186.11108fil\n..\\hbox(6.94444+0.0)x13.88"
        "892\n...\\f a\n...\\f -\n...\\f b\n..\\penalty 100"
        "00\n..\\glue(\\parfillskip) 0.0 plus 1.0fil\n..\\g"
        "lue(\\rightskip) 0.0\n\n! OK.\n[D]\n> \\box0=\n\\v"
        "box(6.94444+0.0)x200.0\n.\\hbox(6.94444+0.0)x200.0"
        ", glue set 186.11108fil\n..\\f a\n..\\f -\n..\\dis"
        "cretionary\n..\\f b\n..\\penalty 10000\n..\\glue("
        "\\parfillskip) 0.0 plus 1.0fil\n..\\glue(\\rightsk"
        "ip) 0.0\n\n! OK.\n[E]\n> \\box0=\n\\vbox(6.94444+0"
        ".0)x200.0\n.\\hbox(6.94444+0.0)x200.0, glue set 18"
        "6.11108fil\n..\\f a\n..\\f -\n..\\discretionary\n."
        ".\\f b\n..\\penalty 10000\n..\\glue(\\parfillskip)"
        " 0.0 plus 1.0fil\n..\\glue(\\rightskip) 0.0\n\n! O"
    ...
    static const char *const expected[] = {
        ...
        "lue set 186.11108fil\n..\\f a\n..\\f b\n..\\f -\n."
        ".\\discretionary\n..\\penalty 10000\n..\\glue(\\pa"
        "rfillskip) 0.0 plus 1.0fil\n..\\glue(\\rightskip) "
        "0.0\n\n! OK.\n[space]\n> \\box0=\n\\vbox(6.94444+0"
        ".0)x200.0\n.\\hbox(6.94444+0.0)x200.0, glue set 17"
        "2.11107fil\n..\\f a\n..\\f b\n..\\f -\n..\\discret"
        "ionary\n..\\glue(\\spaceskip) 4.0\n..\\f c\n..\\f "
        "d\n..\\penalty 10000\n..\\glue(\\parfillskip) 0.0 "
        "plus 1.0fil\n..\\glue(\\rightskip) 0.0\n\n! OK.\n["
        "start]\n> \\box0=\n\\vbox(6.94444+0.0)x200.0\n.\\h"
        "box(6.94444+0.0)x200.0, glue set 186.11108fil\n.."
        "\\f -\n..\\discretionary\n..\\f a\n..\\f b\n..\\pe"
        "nalty 10000\n..\\glue(\\parfillskip) 0.0 plus 1.0f"
        "il\n..\\glue(\\rightskip) 0.0\n\n! OK.\n[kern]\n> "
        "\\box0=\n\\vbox(6.94444+0.0)x200.0\n.\\hbox(6.9444"
        "4+0.0)x200.0, glue set 184.11108fil\n..\\f a\n..\\"
        "f -\n..\\discretionary\n..\\kern 2.0\n..\\f b\n.."
...
static int test_math_nodes(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[A]\n> \\box0=\n\\vbox(6"
        ".94444+1.94444)x200.0\n.\\hbox(6.94444+1.94444)x20"
        "0.0, glue set 133.82188fil\n..\\tenrm a\n..\\glue("
        ...
        "ox(6.94444+1.94444)x200.0, glue set 139.82188fil\n"
        "..\\tenrm a\n..\\glue(\\spaceskip) 4.0\n..\\mathon"
        "\n..\\teni x\n..\\glue(\\medmuskip) 2.22217 plus 1"
        ".11108 minus 2.22217\n..\\tenrm +\n..\\penalty 700"
        "\n..\\glue(\\medmuskip) 2.22217 plus 1.11108 minus"
        " 2.22217\n..\\teni y\n..\\kern0.35878\n..\\glue(\\"
        "thickmuskip) 2.77771 plus 2.77771\n..\\tenrm =\n.."
        "\\penalty 500\n..\\glue(\\thickmuskip) 2.77771 plu"
        "s 2.77771\n..\\teni z\n..\\kern0.4398\n..\\mathoff"
        "\n..\\glue(\\spaceskip) 4.0\n..\\tenrm b\n..\\pena"
        "lty 10000\n..\\glue(\\parfillskip) 0.0 plus 1.0fil"
        "\n..\\glue(\\rightskip) 0.0\n\n! OK.\n[C]\n> \\box"
        "0=\n\\hbox(5.83333+1.94444)x41.62253\n.\\mathon\n."
        "\\teni x\n.\\glue(\\medmuskip) 2.22217 plus 1.1110"
        "8 minus 2.22217\n.\\tenrm +\n.\\glue(\\medmuskip) "
        "2.22217 plus 1.11108 minus 2.22217\n.\\teni y\n.\\"
        "kern0.35878\n.\\glue(\\thickmuskip) 2.77771 plus 2"
        ".77771\n.\\tenrm =\n.\\glue(\\thickmuskip) 2.77771"
        " plus 2.77771\n.\\teni z\n.\\kern0.4398\n.\\mathof"
        "f\n\n! OK.\n[D]\n> \\box0=\n\\vbox(6.94444+1.94444"
...
static int test_hyphenating_ligatures(void)
{
    ...
    static const char *const expected[] = {
        ...
        "l\n..\\glue(\\rightskip) 0.0\n\n! OK.\n[hyphen]\n>"
        " \\box0=\n\\vbox(6.94444+0.0)x200.0\n.\\hbox(6.944"
        "44+0.0)x200.0, glue set 148.49986fil\n..\\f x\n.."
        "\\f x\n..\\glue(\\spaceskip) 4.0\n..\\f c\n..\\f o"
        "\n..\\f ^^L (ligature fi)\n..\\f n\n..\\f a\n..\\f"
        " l\n..\\f -\n..\\discretionary\n..\\f x\n..\\penal"
        "ty 10000\n..\\glue(\\parfillskip) 0.0 plus 1.0fil"
...
static int test_what_a_line_keeps_of_its_break(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[kern]\n> \\box0=\n\\vbo"
        "x(16.30554+0.0)x40.0\n.\\hbox(4.30554+0.0)x40.0\n."
        ".\\f a\n..\\f a\n..\\f a\n..\\f a\n..\\kern 0.0\n."
        ".\\glue(\\rightskip) 0.0\n.\\glue(\\baselineskip) "
        "7.69446\n.\\hbox(4.30554+0.0)x40.0, glue set 19.99"
        "994fil\n..\\f a\n..\\f a\n..\\f a\n..\\f a\n..\\pe"
        "nalty 10000\n..\\glue(\\parfillskip) 0.0 plus 1.0f"
        "il\n..\\glue(\\rightskip) 0.0\n\n! OK.\n[glue]\n> "
...
static int test_math_text_characters(void)
{
    ...
    static const char *const expected[] = {
        ...
        ".83331+0.0)x16.6667\n.\\mathon\n.\\tenrm Y\n.\\ten"
        "rm M\n.\\mathoff\n\n! OK.\n[r]\n> \\box0=\n\\hbox("
        "6.83331+0.0)x16.6667\n.\\mathon\n.\\tenrm Y\n.\\te"
        "nrm M\n.\\mathoff\n\n! OK.\n[ra]\n> \\box0=\n\\hbo"
        "x(6.83331+0.0)x14.16669\n.\\mathon\n.\\tenrm Y\n."
        "\\kern-0.83334\n.\\tenrm A\n.\\mathoff\n\n! OK.\n["
        "rs]\n> \\box0=\n\\hbox(6.83331+1.49998)x20.65283\n"
        ".\\mathon\n.\\tenrm Y\n.\\hbox(4.51111+0.0)x3.9861"
        "3, shifted 1.49998\n..\\sevenrm 1\n.\\tenrm M\n.\\"
        "mathoff\n\n! OK.\n[t]\n> \\box0=\n\\hbox(6.83331+0"
        ".0)x16.6667\n.\\tenrm Y\n.\\tenrm M\n\n! OK.\n> \\"
        "box254=void\n\n! OK.\n",
...
static int test_emergency_stretch(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[none]\n> \\box0=\n\\vbo"
        "x(16.30554+0.0)x60.0\n.\\hbox(4.30554+0.0)x60.0, g"
        "lue set - 1.0 []\n.\\glue(\\baselineskip) 7.69446"
        "\n.\\hbox(4.30554+0.0)x60.0, glue set - 1.0 []\n\n"
        "! OK.\n[some]\n> \\box0=\n\\vbox(28.30554+0.0)x60."
        "0\n.\\hbox(4.30554+0.0)x60.0, glue set 7.99994 []"
        "\n.\\glue(\\baselineskip) 7.69446\n.\\hbox(4.30554"
        "+0.0)x60.0, glue set 7.99994 []\n.\\glue(\\baselin"
        "eskip) 7.69446\n.\\hbox(4.30554+0.0)x60.0, glue se"
        "t 15.99988fil []\n\n! OK.\n> \\box254=void\n\n! OK"
        ".\n",
        NULL,
    };
...
static int test_display_skips_and_widows(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[short]\n> \\box0=\n\\vb"
        "ox(31.30554+0.0)x200.0\n.\\hbox(4.30554+0.0)x200.0"
        ", glue set 189.99997fil\n..\\tenrm a\n..\\tenrm a"
        "\n..\\penalty 10000\n..\\glue(\\parfillskip) 0.0 p"
        "lus 1.0fil\n..\\glue(\\rightskip) 0.0\n.\\penalty "
        "10000\n.\\glue(\\abovedisplayshortskip) 1.0 plus 3"
        ".0\n.\\glue(\\baselineskip) 6.16667\n.\\hbox(5.833"
        "33+1.94444)x23.199, shifted 88.4005, display\n..\\"
        "teni x\n..\\glue(\\medmuskip) 2.22217 plus 1.11108"
        " minus 2.22217\n..\\tenrm +\n..\\glue(\\medmuskip)"
        " 2.22217 plus 1.11108 minus 2.22217\n..\\teni y\n."
        ".\\kern0.35878\n.\\penalty 0\n.\\glue(\\belowdispl"
        "ayshortskip) 2.0 plus 3.0\n.\\glue(\\baselineskip)"
        " 3.11111\n.\\hbox(6.94444+0.0)x200.0, glue set 188"
        ".88885fil\n..\\tenrm b\n..\\tenrm b\n..\\penalty 1"
        "0000\n..\\glue(\\parfillskip) 0.0 plus 1.0fil\n.."
        "\\glue(\\rightskip) 0.0\n\n! OK.\n[long]\n> \\box0"
        ...
        "6\n.\\hbox(4.30554+0.0)x200.0, glue set 175.99994f"
        "il\n..\\tenrm a\n..\\tenrm a\n..\\glue(\\spaceskip"
        ") 4.0\n..\\tenrm a\n..\\tenrm a\n..\\penalty 10000"
        "\n..\\glue(\\parfillskip) 0.0 plus 1.0fil\n..\\glu"
        "e(\\rightskip) 0.0\n.\\penalty 10000\n.\\glue(\\ab"
        "ovedisplayshortskip) 1.0 plus 3.0\n.\\glue(\\basel"
        "ineskip) 6.16667\n.\\hbox(5.83333+1.94444)x23.199,"
        " shifted 88.4005, display\n..\\teni x\n..\\glue(\\"
        "medmuskip) 2.22217 plus 1.11108 minus 2.22217\n.."
        "\\tenrm +\n..\\glue(\\medmuskip) 2.22217 plus 1.11"
        "108 minus 2.22217\n..\\teni y\n..\\kern0.35878\n."
        "\\penalty 0\n.\\glue(\\belowdisplayshortskip) 2.0 "
        "plus 3.0\n.\\glue(\\baselineskip) 3.11111\n.\\hbox"
        "(6.94444+0.0)x200.0, glue set 188.88885fil\n..\\te"
        "nrm b\n..\\tenrm b\n..\\penalty 10000\n..\\glue(\\"
        "parfillskip) 0.0 plus 1.0fil\n..\\glue(\\rightskip"
        ") 0.0\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
...
static int test_prevdepth_belongs_to_one_list(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[f1]\n> \\box0=\n\\hbox("
        "6.9512+4.80951)x4.53473\n.\\mathon\n.\\hbox(6.9512"
        "+4.80951)x4.53473\n..\\hbox(0.0+0.0)x0.0, shifted "
        "-2.5\n..\\vbox(6.9512+4.80951)x4.53473\n...\\hbox("
        "3.01389+0.0)x4.53473 []\n...\\kern1.23732\n...\\ru"
        "le(0.39998+0.0)x*\n...\\kern2.73453\n...\\hbox(3.0"
        "1389+1.3611)x4.53473, glue set 0.114fil []\n..\\hb"
        "ox(0.0+0.0)x0.0, shifted -2.5\n.\\mathoff\n\n! OK."
        "\n[f2]\n> \\box0=\n\\vbox(35.05394+0.0)x200.0\n.\\"
        "hbox(4.30554+0.0)x200.0, glue set 189.99997fil\n.."
        "\\tenrm a\n..\\tenrm a\n..\\penalty 10000\n..\\glu"
        "e(\\parfillskip) 0.0 plus 1.0fil\n..\\glue(\\right"
        "skip) 0.0\n.\\penalty 10000\n.\\glue(\\abovedispla"
        "yshortskip) 1.0 plus 3.0\n.\\glue(\\baselineskip) "
        "0.92938\n.\\hbox(11.07062+8.80396)x5.71527, shifte"
        "d 97.14236, display\n..\\hbox(11.07062+8.80396)x5."
        "71527\n...\\hbox(0.0+0.0)x0.0, shifted -2.5\n...\\"
        "vbox(11.07062+8.80396)x5.71527 []\n...\\hbox(0.0+0"
        ".0)x0.0, shifted -2.5\n.\\penalty 0\n.\\glue(\\bel"
        "owdisplayshortskip) 2.0 plus 3.0\n.\\glue(\\linesk"
        "ip) 0.0\n.\\hbox(6.94444+0.0)x200.0, glue set 188."
        "88885fil\n..\\tenrm b\n..\\tenrm b\n..\\penalty 10"
        "000\n..\\glue(\\parfillskip) 0.0 plus 1.0fil\n..\\"
        "glue(\\rightskip) 0.0\n\n! OK.\n> \\box254=void\n"
...
static int test_whatsit_text_is_cut(void)
{
    ...
    static const char *const expected[] = {
        ...
        "! OK.\n[70]\n> \\box0=\n\\hbox(0.0+0.0)x0.0\n.\\wr"
        "ite1{abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrs"
...
static int test_a_hyphen_that_ligatures(void)
{
    ...
    static const char *const expected[] = {
        ...
        "\n..\\discretionary\n..\\tenrm { (ligature --)\n.."
        "\\glue(\\rightskip) 0.0\n.\\glue(\\baselineskip) 7"
        ".69446\n.\\hbox(4.30554+1.94444)x30.0\n..\\tenrm g"
        "\n..\\tenrm a\n..\\tenrm p\n..\\glue(\\rightskip) "
        "0.0\n.\\glue(\\baselineskip) 3.11111\n.\\hbox(6.94"
        "444+0.0)x30.0, glue set 18.88885fil\n..\\tenrm b\n"
        "..\\tenrm b\n..\\penalty 10000\n..\\glue(\\parfill"
...
static int test_a_repeating_preamble(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[loop]\n> \\box0=\n\\vbo"
        "x(6.83331+1.94444)x65.97237\n.\\hbox(6.83331+1.944"
        "44)x65.97237\n..\\glue(\\tabskip) 3.0\n..\\hbox(6."
        "83331+1.94444)x12.77782\n...\\tenrm A\n...\\tenrm "
        "x\n...\\glue 0.0 plus 1.0fil\n..\\glue(\\tabskip) "
        "3.0\n..\\hbox(6.83331+1.94444)x12.36116\n...\\tenr"
        "m B\n...\\tenrm y\n...\\glue 0.0 plus 1.0fil\n..\\"
        "glue(\\tabskip) 3.0\n..\\hbox(6.83331+1.94444)x11."
        "5278\n...\\tenrm B\n...\\tenrm z\n...\\glue 0.0 pl"
        "us 1.0fil\n..\\glue(\\tabskip) 3.0\n..\\hbox(6.833"
        "31+1.94444)x14.30559\n...\\tenrm B\n...\\tenrm w\n"
        "...\\glue 0.0 plus 1.0fil\n..\\glue(\\tabskip) 3.0"
        "\n\n! OK.\n[plain]\n> \\box0=\n\\vbox(6.83331+1.94"
        "444)x34.13898\n.\\hbox(6.83331+1.94444)x34.13898\n"
        "..\\glue(\\tabskip) 3.0\n..\\hbox(6.83331+1.94444)"
        "x12.77782\n...\\tenrm A\n...\\tenrm x\n...\\glue 0"
        ".0 plus 1.0fil\n..\\glue(\\tabskip) 3.0\n..\\hbox("
        "6.83331+1.94444)x12.36116\n...\\tenrm B\n...\\tenr"
        "m y\n...\\glue 0.0 plus 1.0fil\n..\\glue(\\tabskip"
        ") 3.0\n\n! OK.\n[two]\n> \\box0=\n\\vbox(6.83331+1"
        ".94444)x91.3335\n.\\hbox(6.83331+1.94444)x91.3335"
        "\n..\\glue(\\tabskip) 1.0\n..\\hbox(6.83331+1.9444"
        "4)x13.05559\n...\\tenrm A\n...\\tenrm p\n...\\glue"
        " 0.0 plus 1.0fil\n..\\glue(\\tabskip) 2.0\n..\\hbo"
        "x(6.83331+1.94444)x12.36115\n...\\tenrm B\n...\\te"
        "nrm q\n...\\glue 0.0 plus 1.0fil\n..\\glue(\\tabsk"
        "ip) 3.0\n..\\hbox(6.83331+1.94444)x11.1389\n...\\t"
        "enrm C\n...\\tenrm r\n...\\glue 0.0 plus 1.0fil\n."
        ".\\glue(\\tabskip) 4.0\n..\\hbox(6.83331+1.94444)x"
        "11.0278\n...\\tenrm B\n...\\tenrm s\n...\\glue 0.0"
        " plus 1.0fil\n..\\glue(\\tabskip) 3.0\n..\\hbox(6."
        "83331+1.94444)x11.11113\n...\\tenrm C\n...\\tenrm "
        "t\n...\\glue 0.0 plus 1.0fil\n..\\glue(\\tabskip) "
        "4.0\n..\\hbox(6.83331+1.94444)x12.63893\n...\\tenr"
        "m B\n...\\tenrm u\n...\\glue 0.0 plus 1.0fil\n..\\"
        "glue(\\tabskip) 3.0\n\n! OK.\n> \\box254=void\n\n!"
        " OK.\n",
        NULL,
...
static int test_an_empty_atom(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[e1]\n> \\box0=\n\\hbox("
        "4.30554+0.0)x16.27078\n.\\mathon\n.\\tenrm =\n.\\g"
        "lue(\\thickmuskip) 2.77771 plus 2.77771\n.\\teni x"
        "\n.\\mathoff\n\n! OK.\n[e2]\n> \\box0=\n\\hbox(4.3"
        "0554+0.0)x19.0485\n.\\mathon\n.\\hbox(0.0+0.0)x0.0"
        "\n.\\glue(\\thickmuskip) 2.77771 plus 2.77771\n.\\"
        "tenrm =\n.\\glue(\\thickmuskip) 2.77771 plus 2.777"
        "71\n.\\teni x\n.\\mathoff\n\n! OK.\n[e3]\n> \\box0"
        "=\n\\hbox(4.30554+0.0)x19.0485\n.\\mathon\n.\\teni"
        " x\n.\\glue(\\thickmuskip) 2.77771 plus 2.77771\n."
        "\\tenrm =\n.\\glue(\\thickmuskip) 2.77771 plus 2.7"
        "7771\n.\\hbox(0.0+0.0)x0.0\n.\\mathoff\n\n! OK.\n["
        "e4]\n> \\box0=\n\\hbox(4.30554+1.94444)x24.31009\n"
...
static int test_an_accent_over_a_script(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[a]\n> \\box0=\n\\hbox(6"
        ".67859+1.49998)x10.05292\n.\\mathon\n.\\vbox(6.678"
        "59+1.49998)x10.05292\n..\\hbox(6.67859+0.0)x0.0, s"
        "hifted 0.63542\n...\\tenrm ~\n..\\kern-4.30554\n.."
        ...
        "x(3.01389+0.0)x4.33765, shifted -3.62892\n....\\se"
        "veni a\n.\\mathoff\n\n! OK.\n[Ua]\n> \\box0=\n\\hb"
        "ox(8.20554+1.49998)x11.16542\n.\\mathon\n.\\vbox(8"
        ".20554+1.49998)x11.16542\n..\\hbox(5.67776+0.0)x0."
        "0, shifted 1.7368\n...\\tenrm ^^V\n..\\kern-4.3055"
        "4\n..\\hbox(6.83331+1.49998)x11.16542\n...\\teni U"
        "\n...\\hbox(3.01389+0.0)x4.33765, shifted 1.49998"
        "\n....\\seveni a\n.\\mathoff\n\n! OK.\n[Uc]\n> \\b"
        ...
        "shifted -3.62892\n....\\seveni a\n.\\mathoff\n\n! "
        "OK.\n[Ub]\n> \\box0=\n\\hbox(8.20554+2.83209)x12.2"
        "5568\n.\\mathon\n.\\vbox(8.20554+2.83209)x12.25568"
        "\n..\\hbox(5.67776+0.0)x0.0, shifted 1.7368\n...\\"
        "tenrm ^^V\n..\\kern-4.30554\n..\\hbox(6.83331+2.83"
        "209)x12.25568\n...\\teni U\n...\\vbox(9.4749+0.0)x"
        "5.4279, shifted 2.83209\n....\\hbox(3.01389+0.0)x4"
        ".33765, shifted 1.09026\n.....\\seveni a\n....\\ke"
        ...
        "7859+0.0)x0.0, shifted 4.5243\n...\\tenrm ~\n..\\k"
        "ern-4.30554\n..\\hbox(8.00272+2.39725)x14.04863\n."
        "..\\hbox(0.39998+9.6)x8.33336, shifted -7.20276\n."
        "...\\tensy p\n...\\vbox(8.00272+0.0)x5.71527\n...."
        "\\kern0.39998\n....\\rule(0.39998+0.0)x*\n....\\ke"
        "rn2.89722\n....\\hbox(4.30554+0.0)x5.71527\n....."
        "\\teni x\n.\\hbox(3.01389+0.0)x4.33765, shifted -7"
        ".90356\n..\\seveni a\n.\\mathoff\n\n! OK.\n> \\box"
        "254=void\n\n! OK.\n",
        NULL,
    };
...
static int test_what_resets_the_space_factor(void)
{
    ...
    static const char *const expected[] = {
        ...
        "enrm b\n\n! OK.\n[disc]\n> \\box0=\n\\hbox(7.5+2.5"
        ")x19.44449\n.\\tenrm a\n.\\tenrm ,\n.\\discretiona"
        "ry\n.\\tenrm ]\n.\\glue 3.33333 plus 2.08331 minus"
        " 0.88889\n.\\tenrm b\n\n! OK.\n[none]\n> \\box0=\n"
        "\\hbox(7.5+2.5)x19.44449\n.\\tenrm a\n.\\tenrm ,\n"
        ".\\tenrm ]\n.\\glue 3.33333 plus 2.08331 minus 0.8"
        "8889\n.\\tenrm b\n\n! OK.\n> \\box254=void\n\n! OK"
        ".\n",
        NULL,
    };
...
static int test_the_space_factor_of_a_ligature(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[a]\n> \\box0=\n\\hbox(6"
        ".94444+0.0)x17.77782\n.\\tenrm a\n.\\tenrm .\n.\\g"
        "lue 4.44444 plus 4.99997 minus 0.37036\n.\\tenrm b"
        "\n\n! OK.\n[b]\n> \\box0=\n\\hbox(6.94444+0.0)x22."
        "77783\n.\\tenrm a\n.\\tenrm .\n.\\tenrm \" (ligatu"
...
static int test_operators_that_are_lists(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[log]\n> \\box0=\n\\hbox"
        "(6.94444+1.94444)x13.15627\n.\\mathon\n.\\vbox(6.9"
        "4444+1.94444)x13.15627\n..\\hbox(6.94444+1.94444)x"
        "13.15627\n...\\teni l\n...\\kern0.19678\n...\\teni"
        " o\n...\\teni g\n...\\kern0.35878\n.\\mathoff\n\n!"
        " OK.\n[logs]\n> \\box0=\n\\hbox(12.95831+9.4722)x1"
        "3.15627\n.\\mathon\n.\\vbox(12.95831+9.4722)x13.15"
        "627\n..\\kern1.0\n..\\hbox(3.01389+0.0)x13.15627, "
        "glue set 4.40932fil\n...\\glue 0.0 plus 1.0fil min"
        "us 1.0fil\n...\\seveni a\n...\\glue 0.0 plus 1.0fi"
        "l minus 1.0fil\n..\\kern1.99998\n..\\hbox(6.94444+"
        "1.94444)x13.15627\n...\\teni l\n...\\kern0.19678\n"
        "...\\teni o\n...\\teni g\n...\\kern0.35878\n..\\ke"
        "rn1.66666\n..\\hbox(4.8611+0.0)x13.15627, glue set"
        " 4.81981fil\n...\\glue 0.0 plus 1.0fil minus 1.0fi"
        "l\n...\\seveni b\n...\\glue 0.0 plus 1.0fil minus "
        "1.0fil\n..\\kern1.0\n.\\mathoff\n\n! OK.\n[mx]\n> "
        "\\box0=\n\\hbox(10.66664+0.0)x5.71527\n.\\mathon\n"
        ".\\vbox(10.66664+0.0)x5.71527\n..\\kern1.0\n..\\hb"
        "ox(3.01389+0.0)x5.71527, glue set 0.68881fil\n..."
        ...
        "0)x5.2778\n...\\tenrm x\n..\\kern2.98611\n..\\hbox"
        "(3.01389+0.0)x5.2778, glue set 0.85204fil\n...\\gl"
...
static int test_a_display_closes_its_group_last(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[out]\n> \\box0=\n\\vbox"
        "(15.55553+0.0)x100.0\n.\\hbox(4.30554+1.94444)x100"
        ".0, glue set 94.7222fil []\n.\\penalty 10000\n.\\g"
        "lue(\\abovedisplayshortskip) 1.0\n.\\glue(\\linesk"
        "ip) 1.0\n.\\hbox(0.0+0.0)x0.0, shifted 50.0, displ"
        "ay []\n.\\penalty 0\n.\\glue(\\belowdisplayshortsk"
        "ip) 2.0\n.\\glue(\\lineskip) 1.0\n.\\hbox(4.30554+"
        "0.0)x100.0, glue set 95.55556fil []\n\n! OK.\n[in]"
        "\n> \\box0=\n\\vbox(23.55553+0.0)x100.0\n.\\hbox(4"
        ".30554+1.94444)x100.0, glue set 94.7222fil []\n.\\"
        "penalty 10000\n.\\glue(\\abovedisplayshortskip) 1."
        "0\n.\\glue(\\lineskip) 9.0\n.\\hbox(0.0+0.0)x0.0, "
        "shifted 50.0, display []\n.\\penalty 0\n.\\glue(\\"
        "belowdisplayshortskip) 2.0\n.\\glue(\\lineskip) 1."
        "0\n.\\hbox(4.30554+0.0)x100.0, glue set 95.55556fi"
        "l []\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_lines_carry_on_past_a_display(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[shape]\n> \\box0=\n\\vb"
        "ox(9.0+0.0)x90.0\n.\\hbox(1.0+0.0)x90.0, glue set "
        "25.0fil []\n.\\penalty 10000\n.\\glue(\\abovedispl"
        "ayskip) 3.0\n.\\glue(\\baselineskip) 0.0\n.\\hbox("
        "0.0+0.0)x0.0, shifted 35.0, display []\n.\\penalty"
        " 0\n.\\glue(\\belowdisplayskip) 4.0\n.\\glue(\\lin"
        "eskip) 0.0\n.\\hbox(1.0+0.0)x50.0, glue set 5.0fil"
        " []\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_a_number_beside_a_squeezed_equation(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[room]\n> \\box0=\n\\vbo"
        "x(3.0+0.0)x100.0\n.\\penalty 10000\n.\\glue(\\abov"
        "edisplayshortskip) 1.0\n.\\hbox(0.0+0.0)x94.99998,"
        " shifted 5.00002\n..\\hbox(0.0+0.0)x79.99998, glue"
        " set - 0.88889, display []\n..\\kern5.0\n..\\hbox("
        "0.0+0.0)x10.0, display []\n.\\penalty 0\n.\\glue("
        "\\belowdisplayshortskip) 2.0\n\n! OK.\n[tight]\n> "
        "\\box0=\n\\vbox(1.0+0.0)x100.0\n.\\penalty 10000\n"
        ".\\glue(\\abovedisplayshortskip) 1.0\n.\\hbox(0.0+"
        "0.0)x100.0, glue set - 1.0, display\n..\\hbox(0.0+"
        "0.0)x60.0\n..\\glue 20.0 minus 2.0\n..\\hbox(0.0+0"
        ".0)x40.0\n.\\penalty 10000\n.\\glue(\\baselineskip"
        ") 0.0\n.\\hbox(0.0+0.0)x10.0, shifted 90.0, displa"
        "y\n..\\hbox(0.0+0.0)x10.0\n.\\penalty 0\n\n! OK.\n"
        "[fil]\n> \\box0=\n\\vbox(3.0+0.0)x100.0\n.\\penalt"
        "y 10000\n.\\glue(\\abovedisplayshortskip) 1.0\n.\\"
        "hbox(0.0+0.0)x94.99998, shifted 5.00002\n..\\hbox("
        "0.0+0.0)x79.99998, glue set - 40.00002fil, display"
...
static int test_the_italic_of_a_math_ligature(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[lig]\n> \\box0=\n\\hbox"
        "(6.94444+0.0)x14.9445\n.\\mathon\n.\\tenrm d\n.\\t"
        "enrm i\n.\\tenrm ^^K\n.\\kern0.77779\n.\\mathoff\n"
        "\n! OK.\n[plain]\n> \\box0=\n\\hbox(6.94444+0.0)x1"
        "3.88893\n.\\mathon\n.\\tenrm d\n.\\tenrm i\n.\\ten"
        "rm d\n.\\mathoff\n\n! OK.\n[one]\n> \\box0=\n\\hbo"
        "x(6.94444+0.0)x3.83336\n.\\mathon\n.\\tenrm f\n.\\"
        "kern0.77779\n.\\mathoff\n\n! OK.\n[two]\n> \\box0="
...
static int test_only_a_character_is_centred_still(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[boxed]\n> \\box0=\n\\hb"
        "ox(11.52983+0.0)x7.7778\n.\\mathon\n.\\vbox(11.529"
        "83+0.0)x7.7778\n..\\kern1.0\n..\\hbox(4.8611+0.0)x"
        "7.7778, glue set 2.00348fil\n...\\glue 0.0 plus 1."
        "0fil minus 1.0fil\n...\\sevenrm ?\n...\\glue 0.0 p"
        "lus 1.0fil minus 1.0fil\n..\\kern1.99998\n..\\hbox"
        "(3.66875+0.0)x7.7778\n...\\tenrm =\n.\\mathoff\n\n"
        "! OK.\n[char]\n> \\box0=\n\\hbox(12.51385+0.0)x5.7"
        "1527\n.\\mathon\n.\\vbox(12.51385+0.0)x5.71527\n.."
        "\\kern1.0\n..\\hbox(4.8611+0.0)x5.71527, glue set "
        "0.97221fil\n...\\glue 0.0 plus 1.0fil minus 1.0fil"
        "\n...\\sevenrm ?\n...\\glue 0.0 plus 1.0fil minus "
        "1.0fil\n..\\kern1.99998\n..\\hbox(4.65277+0.0)x5.7"
        "1527\n...\\hbox(4.30554+0.0)x5.71527, shifted -0.3"
        "4723\n....\\teni x\n.\\mathoff\n\n! OK.\n[list]\n>"
        " \\box0=\n\\hbox(12.16663+1.94444)x10.97687\n.\\ma"
        "thon\n.\\vbox(12.16663+1.94444)x10.97687\n..\\kern"
        "1.0\n..\\hbox(4.8611+0.0)x10.97687, glue set 3.603"
        "01fil\n...\\glue 0.0 plus 1.0fil minus 1.0fil\n..."
        "\\sevenrm ?\n...\\glue 0.0 plus 1.0fil minus 1.0fi"
        "l\n..\\kern1.99998\n..\\hbox(4.30554+1.94444)x10.9"
        "7687\n...\\teni x\n...\\teni y\n...\\kern0.35878\n"
        ".\\mathoff\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
...
static int test_a_box_register_in_a_formula(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[grp]\n> \\box0=\n\\hbox"
        "(4.30554+1.94444)x10.5556\n.\\mathon\n.\\hbox(4.30"
        "554+1.94444)x5.2778\n..\\tenrm y\n.\\hbox(4.30554+"
        "1.94444)x5.2778\n..\\tenrm y\n.\\mathoff\n\n! OK."
        "\n[bare]\n> \\box0=\n\\hbox(4.30554+1.94444)x5.277"
        "8\n.\\mathon\n.\\hbox(4.30554+1.94444)x5.2778\n.."
        "\\tenrm y\n.\\mathoff\n\n! OK.\n[sub]\n> \\box0=\n"
        "\\hbox(4.30554+2.44443)x9.61545\n.\\mathon\n.\\hbo"
        "x(4.30554+1.94444)x5.2778\n..\\tenrm y\n.\\hbox(3."
        "01389+0.0)x4.33765, shifted 2.44443\n..\\seveni a"
        "\n.\\mathoff\n\n! OK.\n[void]\n> \\box0=\n\\hbox(4"
        ".30554+0.0)x5.71527\n.\\mathon\n.\\teni x\n.\\math"
        "off\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
...
static int test_a_mark_in_a_list(void)
{
    ...
    static const char *const expected[] = {
        ...
        "\n.\\rule(0.4+0.0)x*\n.\\mark{two}\n\n! OK.\n[h]\n"
        "> \\box0=\n\\vbox(6.94444+0.0)x200.0\n.\\hbox(6.94"
        "444+0.0)x200.0, glue set 178.88882fil\n..\\tenrm a"
        "\n..\\tenrm a\n..\\tenrm b\n..\\tenrm b\n..\\penal"
        "ty 10000\n..\\glue(\\parfillskip) 0.0 plus 1.0fil"
        "\n..\\glue(\\rightskip) 0.0\n.\\mark{three}\n\n! O"
        "K.\n[i]\n> \\box0=\n\\hbox(6.94444+0.0)x21.11118\n"
        ".\\tenrm a\n.\\tenrm a\n.\\mark{four}\n.\\tenrm b"
        "\n.\\tenrm b\n\n! OK.\n[e]\n> \\box0=\n\\vbox(0.4+"
        "0.0)x0.0\n.\\rule(0.4+0.0)x*\n.\\mark{QRA}\n\n! OK"
        ".\n[p]\n> \\box0=\n\\vbox(0.4+0.0)x0.0\n.\\rule(0."
...
static int test_an_insertion_in_a_list(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[a]\n> \\box0=\n\\vbox(0"
        ".4+0.0)x0.0\n.\\rule(0.4+0.0)x*\n.\\insert100, nat"
        "ural size 16.30554; split(5.0,2.0); float cost 77"
        "\n..\\hbox(4.30554+0.0)x5.00002\n...\\tenrm a\n.."
        "\\glue(\\baselineskip) 5.05556\n..\\hbox(6.94444+0"
        ".0)x5.55557\n...\\tenrm b\n\n! OK.\n[b]\n> \\box0="
        "\n\\vbox(0.4+0.0)x0.0\n.\\rule(0.4+0.0)x*\n.\\inse"
        "rt200, natural size 4.30554; split(1.0,3.0); float"
        " cost 5\n..\\hbox(4.30554+0.0)x5.00002\n...\\tenrm"
        " a\n\n! OK.\n[h]\n> \\box0=\n\\vbox(6.94444+0.0)x2"
        "00.0\n.\\hbox(6.94444+0.0)x200.0, glue set 178.888"
        "82fil\n..\\tenrm a\n..\\tenrm a\n..\\tenrm b\n..\\"
        "tenrm b\n..\\penalty 10000\n..\\glue(\\parfillskip"
        ") 0.0 plus 1.0fil\n..\\glue(\\rightskip) 0.0\n.\\i"
        "nsert100, natural size 6.94444; split(5.0,2.0); fl"
        "oat cost 77\n..\\hbox(6.94444+0.0)x5.55557\n...\\t"
        "enrm b\n\n! OK.\n[t]\n> \\box0=\n\\vbox(0.4+0.0)x0"
        ".0\n.\\rule(0.4+0.0)x*\n.\\insert100, natural size"
        " 4.30554; split(5.0,2.0); float cost 77\n..\\hbox("
...
static int test_an_insertion_on_a_page(void)
{
    ...
    static const char *const expected[] = {
        ...
        "t\n\n! OK.\n[ins]\n> \\box100=\n\\vbox(7.0+0.0)x0."
        "0\n.\\rule(7.0+0.0)x*\n\n! OK.\n[1] [goal]\n> \\bo"
        "x1=\n\\hbox(6.44444+1.94444)x168.88934\n.\\tenrm 4"
        "\n.\\tenrm 1\n.\\tenrm .\n.\\tenrm 0\n.\\tenrm 1\n"
        ".\\tenrm 0\n.\\tenrm 9\n.\\tenrm 3\n.\\tenrm p\n."
        "\\tenrm t\n.\\tenrm |\n.\\tenrm 4\n.\\tenrm 0\n.\\"
        "tenrm .\n.\\tenrm 0\n.\\tenrm p\n.\\tenrm t\n.\\te"
...
static int test_marks_on_a_page(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[page1]\n> \\box0=\n\\hb"
        "ox(7.5+2.5)x64.72237\n.\\tenrm /\n.\\tenrm o\n.\\t"
        "enrm n\n.\\tenrm e\n.\\tenrm /\n.\\tenrm t\n.\\ker"
        "n-0.27779\n.\\tenrm w\n.\\kern-0.27779\n.\\tenrm o"
        "\n.\\tenrm /\n.\\tenrm b\n.\\kern0.27779\n.\\tenrm"
        " e\n.\\tenrm t\n.\\tenrm a\n\n! OK.\n[1] [page2]\n"
        "> \\box0=\n\\hbox(7.5+2.5)x84.778\n.\\tenrm t\n.\\"
        "kern-0.27779\n.\\tenrm w\n.\\kern-0.27779\n.\\tenr"
        "m o\n.\\tenrm /\n.\\tenrm f\n.\\tenrm o\n.\\tenrm "
        "u\n.\\tenrm r\n.\\tenrm /\n.\\tenrm f\n.\\tenrm o"
        "\n.\\tenrm u\n.\\tenrm r\n.\\tenrm /\n.\\tenrm b\n"
...
static int test_a_vcenter_in_braces(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[vc]\n> \\box0=\n\\hbox("
        "4.65277+1.94444)x15.97688\n.\\mathon\n.\\teni x\n."
        "\\hbox(4.65277+0.0)x5.00002\n..\\vbox(4.65277+-0.3"
        "4723)x5.00002\n...\\hbox(4.30554+0.0)x5.00002\n..."
        ".\\tenrm a\n.\\teni y\n.\\kern0.35878\n.\\mathoff"
        "\n\n! OK.\n[hb]\n> \\box0=\n\\hbox(4.30554+1.94444"
        ")x15.97688\n.\\mathon\n.\\teni x\n.\\hbox(4.30554+"
        "0.0)x5.00002\n..\\tenrm a\n.\\teni y\n.\\kern0.358"
        "78\n.\\mathoff\n\n! OK.\n[bare]\n> \\box0=\n\\hbox"
        "(4.65277+1.94444)x15.97688\n.\\mathon\n.\\teni x\n"
        ...
        "4+0.0)x5.00002\n...\\tenrm a\n.\\teni y\n.\\kern0."
        "35878\n.\\mathoff\n\n! OK.\n[sup]\n> \\box0=\n\\hb"
        "ox(7.5317+1.94444)x15.97688\n.\\mathon\n.\\teni x"
        "\n.\\vbox(3.90277+0.40277)x5.00002, shifted -3.628"
        "92\n..\\hbox(4.30554+0.0)x5.00002\n...\\tenrm a\n."
        "\\teni y\n.\\kern0.35878\n.\\mathoff\n\n! OK.\n[tw"
        "o]\n> \\box0=\n\\hbox(6.94444+1.94444)x20.26854\n."
        "\\mathon\n.\\teni x\n.\\hbox(6.94444+0.0)x9.29167"
        "\n..\\vbox(4.65277+-0.34723)x5.00002\n...\\hbox(4."
        "30554+0.0)x5.00002\n....\\tenrm a\n..\\teni b\n.\\"
        "teni y\n.\\kern0.35878\n.\\mathoff\n\n! OK.\n> \\b"
        "ox254=void\n\n! OK.\n",
...
static int test_a_limit_at_its_own_width(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[lim]\n> \\box0=\n\\hbox"
        "(13.69998+8.36665)x8.59724\n.\\mathon\n.\\vbox(13."
        "69998+8.36665)x8.59724\n..\\kern1.0\n..\\hbox(4.78"
        "334+0.0)x8.59724\n...\\seveni W\n..\\kern1.99998\n"
        "..\\hbox(5.91666+0.91666)x8.59724, glue set 0.5486"
        "1fil\n...\\glue 0.0 plus 1.0fil minus 1.0fil\n..."
        "\\vbox(5.91666+0.91666)x7.50002\n....\\hbox(6.8333"
        "1+0.0)x7.50002\n.....\\tenrm X\n...\\glue 0.0 plus"
        " 1.0fil minus 1.0fil\n..\\kern1.66666\n..\\hbox(4."
        "78334+0.0)x8.59724, glue set 1.32918fil\n...\\glue"
        " 0.0 plus 1.0fil minus 1.0fil\n...\\seveni Z\n..."
        "\\kern0.49026\n...\\glue 0.0 plus 1.0fil minus 1.0"
        "fil\n..\\kern1.0\n.\\mathoff\n\n! OK.\n[wide]\n> "
        "\\box0=\n\\hbox(7.78333+7.45)x23.75555\n.\\mathon"
        "\n.\\vbox(7.78333+7.45)x23.75555\n..\\kern1.0\n.."
        "\\hbox(4.78334+0.0)x23.75555, glue set 7.57916fil"
        "\n...\\glue 0.0 plus 1.0fil minus 1.0fil\n...\\sev"
        "eni W\n...\\kern1.07639\n...\\glue 0.0 plus 1.0fil"
        " minus 1.0fil\n..\\kern1.99998\n..\\hbox(0.0+0.0)x"
        "23.75555\n..\\kern1.66666\n..\\hbox(4.78334+0.0)x2"
...
static int test_a_rule_between_rows(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[rules]\n> \\box0=\n\\vb"
        "ox(29.74443+0.0)x200.0\n.\\rule(0.4+0.0)x27.11118"
        "\n.\\hbox(6.94444+0.0)x27.11118\n..\\glue(\\tabski"
        "p) 2.0\n..\\hbox(6.94444+0.0)x10.00003\n...\\tenrm"
        " a\n...\\tenrm a\n...\\glue 0.0 plus 1.0fil\n..\\g"
        "lue(\\tabskip) 2.0\n..\\hbox(6.94444+0.0)x11.11115"
        "\n...\\tenrm b\n...\\tenrm b\n...\\glue 0.0 plus 1"
        ".0fil\n..\\glue(\\tabskip) 2.0\n.\\rule(2.0+0.0)x2"
        "7.11118\n.\\rule(0.4+0.0)x5.0\n.\\glue(\\parskip) "
        "7.0\n.\\hbox(1.0+0.0)x200.0, glue set 197.0fil\n.."
        "\\hbox(0.0+0.0)x0.0\n..\\rule(1.0+*)x3.0\n..\\pena"
        "lty 10000\n..\\glue(\\parfillskip) 0.0 plus 1.0fil"
        "\n..\\glue(\\rightskip) 0.0\n.\\glue(\\baselineski"
        "p) 5.05556\n.\\hbox(6.94444+0.0)x27.11118\n..\\glu"
        ...
        ".\\tenrm d\n...\\glue 0.0 plus 1.0fil\n..\\glue(\\"
        "tabskip) 2.0\n\n! OK.\n[first]\n> \\box0=\n\\vbox("
        "13.0+0.0)x200.0\n.\\hbox(1.0+0.0)x200.0, glue set "
        "197.0fil\n..\\hbox(0.0+0.0)x0.0\n..\\rule(1.0+*)x3"
        ".0\n..\\penalty 10000\n..\\glue(\\parfillskip) 0.0"
        " plus 1.0fil\n..\\glue(\\rightskip) 0.0\n.\\glue("
        "\\baselineskip) 7.69446\n.\\hbox(4.30554+0.0)x14.0"
        "0003\n..\\glue(\\tabskip) 2.0\n..\\hbox(4.30554+0."
        "0)x10.00003\n...\\tenrm a\n...\\tenrm a\n...\\glue"
        " 0.0 plus 1.0fil\n..\\glue(\\tabskip) 2.0\n\n! OK."
        "\n> \\box254=void\n\n! OK.\n",
...
static int test_a_row_that_stops_early(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[short]\n> \\box0=\n\\vb"
        "ox(54.94444+0.0)x37.55559\n.\\hbox(6.94444+0.0)x37"
        ".55559\n..\\glue(\\tabskip) 1.0\n..\\hbox(6.94444+"
        "0.0)x5.55557 []\n..\\glue(\\tabskip) 5.0\n..\\hbox"
        "(6.94444+0.0)x5.55557 []\n..\\glue(\\tabskip) 7.0"
        "\n..\\hbox(6.94444+0.0)x4.44444 []\n..\\glue(\\tab"
        "skip) 9.0\n.\\glue(\\baselineskip) 5.05556\n.\\hbo"
        "x(6.94444+0.0)x37.55559\n..\\glue(\\tabskip) 1.0\n"
        "..\\hbox(6.94444+0.0)x5.55557 []\n..\\glue(\\tabsk"
        "ip) 5.0\n.\\glue(\\baselineskip) 5.05556\n.\\hbox("
        "6.94444+0.0)x37.55559\n..\\glue(\\tabskip) 1.0\n.."
        "\\hbox(6.94444+0.0)x5.55557 []\n..\\glue(\\tabskip"
        ") 5.0\n..\\hbox(6.94444+0.0)x5.55557 []\n..\\glue("
        "\\tabskip) 7.0\n.\\glue(\\baselineskip) 12.0\n.\\h"
        "box(0.0+0.0)x37.55559\n..\\glue(\\tabskip) 1.0\n.."
        "\\hbox(0.0+0.0)x5.55557\n..\\glue(\\tabskip) 5.0\n"
        ".\\glue(\\baselineskip) 7.69446\n.\\hbox(4.30554+0"
        ".0)x37.55559\n..\\glue(\\tabskip) 1.0\n..\\hbox(4."
        "30554+0.0)x5.55557 []\n..\\glue(\\tabskip) 5.0\n\n"
        "! OK.\n[one]\n> \\box0=\n\\vbox(16.30554+0.0)x17.1"
        "1115\n.\\hbox(4.30554+0.0)x17.11115\n..\\glue(\\ta"
        "bskip) 1.0\n..\\hbox(4.30554+0.0)x11.11115 []\n.."
        "\\glue(\\tabskip) 5.0\n.\\glue(\\baselineskip) 5.0"
        "5556\n.\\hbox(6.94444+0.0)x17.11115\n..\\glue(\\ta"
        "bskip) 1.0\n..\\hbox(6.94444+0.0)x11.11115 []\n.."
        "\\glue(\\tabskip) 5.0\n\n! OK.\n[two]\n> \\box0=\n"
...
static int test_protruding_past_a_kern(void)
{
    ...
    static const char *const expected[] = {
        ...
        "ght margin)\n..\\penalty -10000\n..\\glue(\\rights"
        "kip) 0.0\n.\\glue(\\baselineskip) 7.69446\n.\\hbox"
        "(4.30554+0.0)x200.0, glue set 186.66667fil\n..\\te"
        "nrm c\n..\\tenrm c\n..\\tenrm c\n..\\penalty 10000"
        "\n..\\glue(\\parfillskip) 0.0 plus 1.0fil\n..\\glu"
        "e(\\rightskip) 0.0\n\n! OK.\n[k]\n> \\box0=\n\\vbo"
        "x(18.94444+0.0)x200.0\n.\\hbox(6.94444+0.0)x200.0,"
        " glue set 43.60442\n..\\tenrm a\n..\\tenrm a\n..\\"
        "tenrm a\n..\\glue 3.33333 plus 1.66666 minus 1.111"
        "11\n..\\tenrm t\n..\\tenrm h\n..\\tenrm e\n..\\glu"
        "e 3.33333 plus 1.66666 minus 1.11111\n..\\mathon\n"
        "..\\teni X\n..\\kern0.7847\n..\\teni Y\n..\\kern2."
        "22223\n..\\kern 2.0\n..\\mathoff\n..\\special{x}\n"
        "..\\penalty -10000\n..\\glue(\\rightskip) 0.0\n.\\"
        "glue(\\baselineskip) 7.69446\n.\\hbox(4.30554+0.0)"
        "x200.0, glue set 186.66667fil\n..\\tenrm c\n..\\te"
        "nrm c\n..\\tenrm c\n..\\penalty 10000\n..\\glue(\\"
        "parfillskip) 0.0 plus 1.0fil\n..\\glue(\\rightskip"
        ") 0.0\n\n! OK.\n[z]\n> \\box0=\n\\vbox(18.94444+0."
        "0)x200.0\n.\\hbox(6.94444+0.0)x200.0, glue set 47."
        "6836\n..\\tenrm a\n..\\tenrm a\n..\\tenrm a\n..\\g"
        ...
        "\\penalty -10000\n..\\glue(\\rightskip) 0.0\n.\\gl"
        "ue(\\baselineskip) 7.69446\n.\\hbox(4.30554+0.0)x2"
        "00.0, glue set 186.66667fil\n..\\tenrm c\n..\\tenr"
        "m c\n..\\tenrm c\n..\\penalty 10000\n..\\glue(\\pa"
        "rfillskip) 0.0 plus 1.0fil\n..\\glue(\\rightskip) "
        "0.0\n\n! OK.\n[e]\n> \\box0=\n\\vbox(18.94444+0.0)"
        "x200.0\n.\\hbox(6.94444+0.0)x200.0, glue set 46.48"
        "36\n..\\tenrm a\n..\\tenrm a\n..\\tenrm a\n..\\glu"
        "e 3.33333 plus 1.66666 minus 1.11111\n..\\tenrm t"
        "\n..\\tenrm h\n..\\tenrm e\n..\\glue 3.33333 plus "
        "1.66666 minus 1.11111\n..\\tenrm Y\n..\\kern 2.0\n"
...
static int test_a_space_leaves_the_factor_alone(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[sf]\n> \\box0=\n\\hbox("
        "6.94444+1.94444)x81.94456\n.\\tenrm a\n.\\tenrm b"
        "\n.\\kern0.27779\n.\\tenrm c\n.\\tenrm .\n.\\glue "
        "4.44444 plus 4.99997 minus 0.37036\n.\\glue 3.0\n."
        "\\tenrm x\n.\\tenrm .\n.\\glue 4.44444 plus 4.9999"
        "7 minus 0.37036\n.\\kern 2.0\n.\\tenrm y\n.\\kern-"
        "0.83334\n.\\tenrm .\n.\\glue 4.44444 plus 4.99997 "
        "minus 0.37036\n.\\penalty 5\n.\\tenrm z\n.\\tenrm "
        ".\n.\\hbox(0.0+0.0)x0.0, shifted 1.0\n.\\glue 3.33"
...
static int test_the_look_before_an_entry(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[peek]\n> \\box0=\n\\vbo"
        "x(18.83331+0.0)x27.29858\n.\\hbox(6.83331+0.0)x27."
        "29858\n..\\glue(\\tabskip) 0.0\n..\\hbox(6.83331+0"
        ".0)x10.79166\n...\\mathon\n...\\teni M\n...\\kern1"
        ".09026\n...\\mathoff\n...\\glue 0.0 plus 1.0fil\n."
        ".\\glue(\\tabskip) 0.0\n..\\hbox(6.83331+0.0)x16.5"
        "0693, glue set 9.27428fil\n...\\mathon\n...\\teni "
        "T\n...\\kern1.3889\n...\\mathoff\n...\\glue 0.0 pl"
        "us 1.0fil\n..\\glue(\\tabskip) 0.0\n.\\glue(\\base"
        "lineskip) 5.16669\n.\\hbox(6.83331+0.0)x27.29858\n"
        "..\\glue(\\tabskip) 0.0\n..\\hbox(6.83331+0.0)x10."
        "79166\n...\\tenrm T\n..\\glue(\\tabskip) 0.0\n..\\"
        "hbox(6.83331+0.0)x16.50693\n...\\mathon\n...\\teni"
        " x\n...\\teni M\n...\\kern1.09026\n...\\mathoff\n."
        "..\\glue 0.0 plus 1.0fil\n..\\glue(\\tabskip) 0.0"
        "\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
...
static int test_a_kern_in_mu(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[k]\n> \\box0=\n\\hbox(6"
        ".94444+1.94444)x42.97665\n.\\tenrm a\n.\\kern 3.0"
        "\n.\\tenrm b\n.\\kern 0.0\n.\\glue(\\spaceskip) 4."
        "0\n.\\tenrm c\n.\\mathon\n.\\teni x\n.\\kern 9.999"
        "76\n.\\teni y\n.\\kern0.35878\n.\\mathoff\n\n! OK."
        "\n[t]\n> \\box0=\n\\hbox(4.30554+1.94444)x37.49518"
        "\n.\\mathon\n.\\teni x\n.\\glue(\\nonscript)\n.\\g"
        "lue 4.99988\n.\\teni y\n.\\kern0.35878\n.\\glue(\\"
        "nonscript)\n.\\kern 4.99988\n.\\teni z\n.\\kern0.4"
        "398\n.\\glue(\\nonscript)\n.\\glue(\\spaceskip) 4."
        "0\n.\\teni w\n.\\kern0.26909\n.\\mathoff\n\n! OK."
        "\n[s]\n> \\box0=\n\\hbox(3.01389+1.3611)x12.94916"
        "\n.\\mathon\n.\\seveni x\n.\\glue(\\nonscript)\n."
        "\\seveni y\n.\\kern0.25116\n.\\glue(\\nonscript)\n"
        ".\\seveni z\n.\\kern0.28703\n.\\mathoff\n\n! OK.\n"
        "[n]\n> \\box0=\n\\hbox(4.30554+1.94444)x10.97687\n"
        ".\\mathon\n.\\teni x\n.\\glue(\\nonscript)\n.\\ten"
        "i y\n.\\kern0.35878\n.\\mathoff\n\n! OK.\n> \\box2"
        "54=void\n\n! OK.\n",
        NULL,
...
static int test_an_accent_alone_in_braces(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[alone]\n> \\box0=\n\\hb"
        "ox(8.20554+1.94444)x21.81021\n.\\mathon\n.\\teni x"
        "\n.\\vbox(8.20554+0.0)x10.83334\n..\\hbox(5.67776+"
        "0.0)x0.0, shifted 2.91667\n...\\tenrm ^^V\n..\\ker"
        "n-4.30554\n..\\hbox(6.83331+0.0)x10.83334\n...\\te"
        "ni W\n.\\teni y\n.\\kern0.35878\n.\\mathoff\n\n! O"
        "K.\n[ord]\n> \\box0=\n\\hbox(8.20554+1.94444)x25.7"
        "9634\n.\\mathon\n.\\teni x\n.\\vbox(8.20554+0.0)x1"
        "4.81947\n..\\hbox(5.67776+0.0)x0.0, shifted 2.9166"
        "7\n...\\tenrm ^^V\n..\\kern-5.61226\n..\\hbox(8.14"
        "003+0.0)x14.81947\n...\\teni W\n...\\kern1.3889\n."
        "..\\hbox(4.51111+0.0)x3.98613, shifted -3.62892\n."
        "...\\sevenrm 2\n.\\teni y\n.\\kern0.35878\n.\\math"
        "off\n\n! OK.\n[op]\n> \\box0=\n\\hbox(8.20554+1.94"
        "444)x21.81021\n.\\mathon\n.\\teni x\n.\\glue(\\thi"
        "nmuskip) 0.0\n.\\hbox(8.20554+0.0)x10.83334\n..\\v"
        "box(8.20554+0.0)x10.83334\n...\\hbox(5.67776+0.0)x"
        "0.0, shifted 2.91667\n....\\tenrm ^^V\n...\\kern-4"
        ".30554\n...\\hbox(6.83331+0.0)x10.83334\n....\\ten"
        "i W\n.\\glue(\\thinmuskip) 0.0\n.\\teni y\n.\\kern"
        "0.35878\n.\\mathoff\n\n! OK.\n[two]\n> \\box0=\n\\"
        ...
        "+0.0)x10.83334\n...\\hbox(5.67776+0.0)x0.0, shifte"
        "d 2.91667\n....\\tenrm ^^V\n...\\kern-4.30554\n..."
        "\\hbox(6.83331+0.0)x10.83334\n....\\teni W\n..\\te"
        "ni a\n.\\teni y\n.\\kern0.35878\n.\\mathoff\n\n! O"
        "K.\n[frac]\n> \\box0=\n\\hbox(13.59839+7.10547)x10"
        ".83334\n.\\mathon\n.\\hbox(13.59839+7.10547)x10.83"
        "334\n..\\hbox(13.59839+7.10547)x10.83334\n...\\hbo"
        "x(0.0+0.0)x0.0, shifted -2.5\n...\\vbox(13.59839+7"
        ".10547)x10.83334\n....\\hbox(6.83331+0.0)x10.83334"
        "\n.....\\teni W\n....\\kern4.06508\n....\\rule(0.3"
        "9998+0.0)x*\n....\\kern1.19994\n....\\vbox(8.20554"
        "+0.0)x10.83334\n.....\\hbox(5.67776+0.0)x0.0, shif"
        "ted 2.91667\n......\\tenrm ^^V\n.....\\kern-4.3055"
        "4\n.....\\hbox(6.83331+0.0)x10.83334\n......\\teni"
        " W\n...\\hbox(0.0+0.0)x0.0, shifted -2.5\n.\\matho"
        "ff\n\n! OK.\n> \\box254=void\n\n! OK.\n",
...
static int test_a_fence_is_set_in_place(void)
{
    ...
    static const char *const expected[] = {
        ...
        "x(14.50012+9.50012)x21.91524\n..\\vbox(0.0+24.0002"
        "4)x3.33333, shifted -14.50012\n...\\hbox(0.0+6.000"
        "06)x3.33333\n....\\tenex ^^L\n...\\hbox(0.0+6.0000"
        "6)x3.33333\n....\\tenex ^^L\n...\\hbox(0.0+6.00006"
        ")x3.33333\n....\\tenex ^^L\n...\\hbox(0.0+6.00006)"
        "x3.33333\n....\\tenex ^^L\n..\\vbox(13.61122+8.611"
        "24)x10.00002\n...\\hbox(13.61122+8.61124)x10.00002"
        "\n....\\hbox(0.0+22.22246)x10.00002, shifted -13.6"
        "1122\n.....\\tenex Z\n..\\glue(\\thinmuskip) 1.666"
        "63\n..\\teni x\n..\\hbox(0.0+0.0)x1.2, shifted -2."
        "5\n.\\mathoff\n\n! OK.\n[numerator]\n> \\box0=\n\\"
        "hbox(15.90005+8.80396)x20.98189\n.\\mathon\n.\\hbo"
        "x(15.90005+8.80396)x20.98189\n..\\hbox(15.90005+8."
        "80396)x20.98189\n...\\hbox(0.0+0.0)x1.2, shifted -"
        "2.5\n...\\vbox(15.90005+8.80396)x18.5819\n....\\hb"
        "ox(8.50006+3.50006)x18.5819\n.....\\vbox(0.0+12.00"
        "012)x3.33333, shifted -8.50006 []\n.....\\hbox(0.0"
        "+11.11122)x6.66667, shifted -8.0556 []\n.....\\glu"
        "e(\\thinmuskip) 1.66663\n.....\\teni x\n.....\\hbo"
        "x(0.0+0.0)x1.2, shifted -2.5\n....\\kern1.19994\n."
        "...\\rule(0.39998+0.0)x*\n....\\kern4.85397\n...."
        "\\hbox(4.30554+1.94444)x18.5819, glue set 6.66016f"
        "il\n.....\\glue 0.0 plus 1.0fil minus 1.0fil\n...."
        ".\\teni y\n.....\\kern0.35878\n.....\\glue 0.0 plu"
        "s 1.0fil minus 1.0fil\n...\\hbox(0.0+0.0)x1.2, shi"
        "fted -2.5\n.\\mathoff\n\n! OK.\n[script]\n> \\box0"
        "=\n\\hbox(16.53903+9.50012)x25.90137\n.\\mathon\n."
        "\\hbox(14.50012+9.50012)x21.91524\n..\\vbox(0.0+24"
        ".00024)x3.33333, shifted -14.50012\n...\\hbox(0.0+"
        "6.00006)x3.33333\n....\\tenex ^^L\n...\\hbox(0.0+6"
        ".00006)x3.33333\n....\\tenex ^^L\n...\\hbox(0.0+6."
        "00006)x3.33333\n....\\tenex ^^L\n...\\hbox(0.0+6.0"
        "0006)x3.33333\n....\\tenex ^^L\n..\\vbox(13.61122+"
        "8.61124)x10.00002\n...\\hbox(13.61122+8.61124)x10."
        "00002\n....\\hbox(0.0+22.22246)x10.00002, shifted "
        "-13.61122\n.....\\tenex Z\n..\\glue(\\thinmuskip) "
        "1.66663\n..\\teni x\n..\\hbox(0.0+0.0)x1.2, shifte"
        "d -2.5\n.\\hbox(4.51111+0.0)x3.98613, shifted -12."
        "02792\n..\\sevenrm 2\n.\\mathoff\n\n! OK.\n> \\box"
        "254=void\n\n! OK.\n",
        NULL,
    };
...
static int test_delimiters_are_atoms(void)
{
    ...
    static const char *const expected[] = {
        ...
        "79\n...\\tensy j\n..\\tenrm +\n..\\teni x\n..\\hbo"
        "x(0.0+0.0)x1.2, shifted -2.5\n.\\mathoff\n\n! OK."
        "\n[after]\n> \\box0=\n\\hbox(7.5+2.5)x23.3782\n.\\"
        "mathon\n.\\teni y\n.\\kern0.35878\n.\\glue(\\thinm"
        "uskip) 1.66663\n.\\hbox(7.5+2.5)x9.69305\n..\\hbox"
        "(7.5+2.5)x2.77779\n...\\tensy j\n..\\teni x\n..\\h"
        "box(0.0+0.0)x1.2, shifted -2.5\n.\\glue(\\thinmusk"
        "ip) 1.66663\n.\\teni z\n.\\kern0.4398\n.\\mathoff"
        "\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
...
static int test_what_stands_between_delimiters(void)
{
    ...
    static const char *const expected[] = {
        ...
        ".\\kern0.35878\n..\\hbox(0.0+0.0)x1.2, shifted -2."
        "5\n.\\mathoff\n\n! OK.\n[vb]\n> \\box0=\n\\hbox(8."
        "50006+3.50006)x4.53333\n.\\mathon\n.\\hbox(8.50006"
        "+3.50006)x4.53333\n..\\vbox(0.0+12.00012)x3.33333,"
...
static int test_a_display_squeezed_to_fit(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[over]\n> \\box0=\n\\vbo"
        "x(3.0+0.0)x100.0\n.\\penalty 10000\n.\\glue(\\abov"
        "edisplayshortskip) 1.0\n.\\hbox(0.0+0.0)x100.0, gl"
        "ue set - 1.0, display\n..\\hbox(0.0+0.0)x60.0\n.."
        "\\glue 0.0\n..\\glue 20.0 minus 10.0\n..\\hbox(0.0"
        "+0.0)x60.0\n.\\penalty 0\n.\\glue(\\belowdisplaysh"
        "ortskip) 2.0\n\n! OK.\n[fits]\n> \\box0=\n\\vbox(3"
        ".0+0.0)x100.0\n.\\penalty 10000\n.\\glue(\\abovedi"
        "splayshortskip) 1.0\n.\\hbox(0.0+0.0)x100.0, glue "
        "set - 1.0, display\n..\\hbox(0.0+0.0)x60.0\n..\\gl"
        "ue 20.0 minus 40.0\n..\\hbox(0.0+0.0)x60.0\n.\\pen"
        "alty 0\n.\\glue(\\belowdisplayshortskip) 2.0\n\n! "
        "OK.\n[num]\n> \\box0=\n\\vbox(1.0+0.0)x100.0\n.\\p"
        "enalty 10000\n.\\glue(\\abovedisplayshortskip) 1.0"
        "\n.\\hbox(0.0+0.0)x100.0, glue set - 1.0, display"
        "\n..\\hbox(0.0+0.0)x60.0\n..\\glue 20.0 minus 40.0"
        "\n..\\hbox(0.0+0.0)x60.0\n.\\penalty 10000\n.\\glu"
        "e(\\baselineskip) 0.0\n.\\hbox(0.0+0.0)x10.0, shif"
        "ted 90.0, display\n..\\hbox(0.0+0.0)x10.0\n.\\pena"
        "lty 0\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
...
static int test_the_size_before_a_display(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[rigid]\n> \\box0=\n\\vb"
        "ox(7.30554+0.0)x100.0\n.\\hbox(4.30554+0.0)x100.0 "
        "[]\n.\\penalty 10000\n.\\glue(\\abovedisplayshorts"
        "kip) 1.0\n.\\glue(\\baselineskip) 0.0\n.\\hbox(0.0"
        "+0.0)x10.0, shifted 45.0, display []\n.\\penalty 0"
        "\n.\\glue(\\belowdisplayshortskip) 2.0\n\n! OK.\n["
        "stretch]\n> \\box0=\n\\vbox(11.30554+0.0)x100.0\n."
        "\\hbox(4.30554+0.0)x100.0, glue set 42.7222 []\n."
        "\\penalty 10000\n.\\glue(\\abovedisplayskip) 3.0\n"
        ".\\glue(\\baselineskip) 0.0\n.\\hbox(0.0+0.0)x10.0"
        ", shifted 45.0, display []\n.\\penalty 0\n.\\glue("
        "\\belowdisplayskip) 4.0\n\n! OK.\n[shrink]\n> \\bo"
        ...
        "\\penalty 0\n.\\glue(\\belowdisplayshortskip) 2.0"
        "\n\n! OK.\n[shifted]\n> \\box0=\n\\vbox(11.30554+0"
        ".0)x100.0\n.\\hbox(4.30554+0.0)x70.0, shifted 30.0"
        " []\n.\\penalty 10000\n.\\glue(\\abovedisplayskip)"
        " 3.0\n.\\glue(\\baselineskip) 0.0\n.\\hbox(0.0+0.0"
        ")x10.0, shifted 45.0, display []\n.\\penalty 0\n."
        "\\glue(\\belowdisplayskip) 4.0\n\n! OK.\n> \\box25"
        "4=void\n\n! OK.\n",
        NULL,
    };
...
static int test_a_short_display_skip(void)
{
    ...
    static const char *const expected[] = {
        ...
        "(7.0+0.0)x100.0\n.\\hbox(0.0+0.0)x100.0 []\n.\\pen"
        "alty 10000\n.\\glue(\\abovedisplayskip) 3.0\n.\\gl"
        "ue(\\baselineskip) 0.0\n.\\hbox(0.0+0.0)x85.0, shi"
        "fted 15.0 []\n.\\penalty 0\n.\\glue(\\belowdisplay"
        "skip) 4.0\n\n! OK.\n[bare]\n> \\box0=\n\\vbox(3.0+"
        "0.0)x100.0\n.\\hbox(0.0+0.0)x100.0 []\n.\\penalty "
        "10000\n.\\glue(\\abovedisplayshortskip) 1.0\n.\\gl"
        "ue(\\baselineskip) 0.0\n.\\hbox(0.0+0.0)x50.0, shi"
        "fted 25.0, display []\n.\\penalty 0\n.\\glue(\\bel"
        "owdisplayshortskip) 2.0\n\n! OK.\n> \\box254=void"
        "\n\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_large_operators(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[t]\n> \\box0=\n\\hbox(8"
        ".0556+3.05562)x6.66667\n.\\mathon\n.\\hbox(0.0+11."
        "11122)x6.66667, shifted -8.0556\n..\\tenex R\n.\\m"
        "athoff\n\n! OK.\n[d]\n> \\box0=\n\\hbox(13.61122+8"
        ".61124)x10.00002\n.\\mathon\n.\\vbox(13.61122+8.61"
        "124)x10.00002\n..\\hbox(13.61122+8.61124)x10.00002"
        "\n...\\hbox(0.0+22.22246)x10.00002, shifted -13.61"
        "122\n....\\tenex Z\n.\\mathoff\n\n! OK.\n[s]\n> \\"
        "box0=\n\\hbox(10.50006+5.50006)x14.44447\n.\\matho"
        "n\n.\\vbox(10.50006+5.50006)x14.44447\n..\\hbox(10"
        ".50006+5.50006)x14.44447\n...\\hbox(1.0+15.00012)x"
        "14.44447, shifted -9.50006\n....\\tenex X\n.\\math"
        "off\n\n! OK.\n[sl]\n> \\box0=\n\\hbox(16.51393+13."
        "02782)x14.44447\n.\\mathon\n.\\vbox(16.51393+13.02"
        "782)x14.44447\n..\\kern1.0\n..\\hbox(3.01389+0.0)x"
        "14.44447, glue set 5.05342fil\n...\\glue 0.0 plus "
        "1.0fil minus 1.0fil\n...\\seveni a\n...\\glue 0.0 "
        "plus 1.0fil minus 1.0fil\n..\\kern1.99998\n..\\hbo"
        "x(10.50006+5.50006)x14.44447\n...\\hbox(1.0+15.000"
        "12)x14.44447, shifted -9.50006\n....\\tenex X\n.."
        "\\kern1.66666\n..\\hbox(4.8611+0.0)x14.44447, glue"
        " set 5.46391fil\n...\\glue 0.0 plus 1.0fil minus 1"
        ".0fil\n...\\seveni b\n...\\glue 0.0 plus 1.0fil mi"
        "nus 1.0fil\n..\\kern1.0\n.\\mathoff\n\n! OK.\n[st]"
        "\n> \\box0=\n\\hbox(8.04175+3.00005)x14.89323\n.\\"
        "mathon\n.\\hbox(0.0+10.00012)x10.55559, shifted -7"
        ".50006\n..\\tenex P\n.\\vbox(11.0418+0.0)x4.33765,"
        " shifted 3.00005\n..\\hbox(3.01389+0.0)x4.33765\n."
        "..\\seveni a\n..\\kern3.16681\n..\\hbox(4.8611+0.0"
        ")x3.51666\n...\\seveni b\n.\\mathoff\n\n! OK.\n[nl"
        "]\n> \\box0=\n\\hbox(11.04175+6.00005)x18.78212\n."
        "\\mathon\n.\\hbox(1.0+15.00012)x14.44447, shifted "
        "-9.50006\n..\\tenex X\n.\\vbox(17.0418+0.0)x4.3376"
        "5, shifted 6.00005\n..\\hbox(3.01389+0.0)x4.33765"
        "\n...\\seveni a\n..\\kern9.16681\n..\\hbox(4.8611+"
        "0.0)x3.51666\n...\\seveni b\n.\\mathoff\n\n! OK.\n"
        ...
        ", shifted 3.5556\n..\\hbox(3.01389+0.0)x4.33765, s"
        "hifted 1.94444\n...\\seveni a\n..\\kern4.27791\n.."
        "\\hbox(4.8611+0.0)x3.51666\n...\\seveni b\n.\\math"
        "off\n\n! OK.\n[id]\n> \\box0=\n\\hbox(19.62509+16."
        "13899)x10.00002\n.\\mathon\n.\\vbox(19.62509+16.13"
        "899)x10.00002\n..\\kern1.0\n..\\hbox(3.01389+0.0)x"
        "10.00002, glue set 2.83119fil, shifted 2.22223\n.."
        ".\\glue 0.0 plus 1.0fil minus 1.0fil\n...\\seveni "
        "a\n...\\glue 0.0 plus 1.0fil minus 1.0fil\n..\\ker"
        "n1.99998\n..\\hbox(13.61122+8.61124)x10.00002\n..."
        "\\hbox(0.0+22.22246)x10.00002, shifted -13.61122\n"
        "....\\tenex Z\n..\\kern1.66666\n..\\hbox(4.8611+0."
        "0)x10.00002, glue set 3.24168fil, shifted -2.22223"
        "\n...\\glue 0.0 plus 1.0fil minus 1.0fil\n...\\sev"
        "eni b\n...\\glue 0.0 plus 1.0fil minus 1.0fil\n.."
        "\\kern1.0\n.\\mathoff\n\n! OK.\n[il]\n> \\box0=\n"
        "\\hbox(14.06947+10.58337)x6.66667\n.\\mathon\n.\\v"
        "box(14.06947+10.58337)x6.66667\n..\\kern1.0\n..\\h"
        "box(3.01389+0.0)x6.66667, glue set 1.16452fil, shi"
        "fted 0.97223\n...\\glue 0.0 plus 1.0fil minus 1.0f"
        "il\n...\\seveni a\n...\\glue 0.0 plus 1.0fil minus",
        " 1.0fil\n..\\kern1.99998\n..\\hbox(8.0556+3.05562)"
        "x6.66667\n...\\hbox(0.0+11.11122)x6.66667, shifted"
        " -8.0556\n....\\tenex R\n..\\kern1.66666\n..\\hbox"
        "(4.8611+0.0)x6.66667, glue set 1.57501fil, shifted"
        " -0.97223\n...\\glue 0.0 plus 1.0fil minus 1.0fil"
        "\n...\\seveni b\n...\\glue 0.0 plus 1.0fil minus 1"
        ".0fil\n..\\kern1.0\n.\\mathoff\n\n! OK.\n[sup]\n> "
        ...
        "athon\n.\\hbox(0.0+11.11122)x4.72223, shifted -8.0"
        "556\n..\\tenex R\n.\\hbox(4.8611+0.0)x3.51666, shi"
        "fted 3.5556\n..\\seveni b\n.\\mathoff\n\n! OK.\n> "
        "\\box254=void\n\n! OK.\n",
        NULL,
    };
...
static int test_tracing_paragraphs(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n@firstpass\n@secondpass"
        "\n\\tenrm one two three four ab-\n@\\discretionary"
        " via @@0 b=0 p=50 d=2600\n@@1: line 1.2- t=2600 ->"
        " @@0\nraca-da-bra five six seven \n@ via @@1 b=* p"
        "=0 d=*\n@@2: line 2.3 t=2600 -> @@1\neight \n@\\pa"
        "r via @@2 b=0 p=-10000 d=*\n@@3: line 3.2- t=2600 "
        "-> @@2\n\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_pdf_destinations(void)
{
    ...
    static const char *const expected[] = {
        ...
        ".94444+0.0)x10.55559\n.\\tenrm a\n.\\pdfdest name{"
        "x} xyz\n.\\tenrm b\n\n! OK.\n[b]\n> \\box0=\n\\hbo"
        "x(0.0+0.0)x0.0\n.\\pdfdest num7 xyz zoom2000\n\n! "
        "OK.\n[c]\n> \\box0=\n\\hbox(0.0+0.0)x0.0\n.\\pdfde"
        "st name{y} fitbv\n\n! OK.\n[d]\n> \\box0=\n\\hbox("
        "0.0+0.0)x0.0\n.\\pdfdest name{z} fitr(3.0+1.0)x10."
        "0\n\n! OK.\n[e]\n> \\box0=\n\\hbox(0.0+0.0)x0.0\n."
        "\\pdfdest name{w} fitr(3.0+*)x*\n\n! OK.\n[f]\n> "
        "\\box0=\n\\hbox(0.0+0.0)x0.0\n.\\pdfdest name{aaaa"
        "aaaaaabbbbbbbbbbccccccccccddddddddddeeeeeeeeeeffff"
        "ffffffgggg\nggggg\\ETC.} fit\n\n! OK.\n> \\box254="
        "void\n\n! OK.\n",
        NULL,
    };
...
static int test_the_last_node_of_a_page(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[A=-1] [B=1] [C=11][Cs=3"
        ".0pt] [D=13][Dp=5] [E=12][Ek=2.0pt]\n[F=1][Fs=0.0p"
        "t][Fk=0.0pt][Fp=0] [G=-1] [H=1]\n> \\box254=void\n"
        "\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_a_line_that_breaks_at_a_penalty(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[forced]\n> \\box0=\n\\v"
        "box(16.30554+0.0)x200.0\n.\\hbox(4.30554+0.0)x200."
        "0\n..\\tenrm a\n..\\tenrm a\n..\\penalty -10000\n."
        ".\\glue(\\rightskip) 0.0\n.\\glue(\\baselineskip) "
        "5.05556\n.\\hbox(6.94444+0.0)x200.0, glue set 188."
        "88885fil\n..\\tenrm b\n..\\tenrm b\n..\\penalty 10"
...
static int test_a_list_that_is_one_box(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[one]\n> \\box0=\n\\hbox"
        "(6.83331+0.0)x20.83607\n.\\mathon\n.\\teni U\n.\\k"
        "ern1.09026\n.\\hbox(4.30554+0.0)x5.00002\n..\\tenr"
        "m a\n.\\teni U\n.\\kern1.09026\n.\\mathoff\n\n! OK"
        ".\n[shift]\n> \\box0=\n\\hbox(6.83331+0.0)x21.5513"
        "3\n.\\mathon\n.\\teni U\n.\\kern1.09026\n.\\hbox(4"
        ".65277+0.0)x5.71527\n..\\hbox(4.30554+0.0)x5.71527"
        ", shifted -0.34723\n...\\teni x\n.\\teni U\n.\\ker"
        "n1.09026\n.\\mathoff\n\n! OK.\n[pair]\n> \\box0=\n"
...
static int test_math_accents(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[bar]\n> \\box0=\n\\hbox"
        "(8.20554+0.0)x7.91803\n.\\mathon\n.\\vbox(8.20554+"
        "0.0)x7.91803\n..\\hbox(5.67776+0.0)x0.0, shifted 1"
        ".7368\n...\\tenrm ^^V\n..\\kern-4.30554\n..\\hbox("
        "6.83331+0.0)x7.91803\n...\\teni U\n.\\mathoff\n\n!"
        " OK.\n[hat]\n> \\box0=\n\\hbox(9.47221+0.0)x7.5000"
        "2\n.\\mathon\n.\\vbox(9.47221+0.0)x7.50002\n..\\hb"
        "ox(6.94444+0.0)x0.0, shifted 2.63893\n...\\tenrm ^"
        "\n..\\kern-4.30554\n..\\hbox(6.83331+0.0)x7.50002"
        "\n...\\teni A\n.\\mathoff\n\n! OK.\n[wide]\n> \\bo"
        "x0=\n\\hbox(8.20554+0.0)x15.83606\n.\\mathon\n.\\v"
        "box(8.20554+0.0)x15.83606\n..\\hbox(5.67776+0.0)x0"
        ".0, shifted 5.41803\n...\\tenrm ^^V\n..\\kern-4.30"
        "554\n..\\hbox(6.83331+0.0)x15.83606\n...\\teni U\n"
        "...\\kern1.09026\n...\\teni U\n...\\kern1.09026\n."
        "\\mathoff\n\n! OK.\n[low]\n> \\box0=\n\\hbox(5.677"
        "76+0.0)x5.71527\n.\\mathon\n.\\vbox(5.67776+0.0)x5"
        ".71527\n..\\hbox(5.67776+0.0)x0.0, shifted 0.63542"
        "\n...\\tenrm ^^V\n..\\kern-4.30554\n..\\hbox(4.305"
        "54+0.0)x5.71527\n...\\teni x\n.\\mathoff\n\n! OK."
        "\n[script]\n> \\box0=\n\\hbox(7.64835+0.0)x12.2247"
        "8\n.\\mathon\n.\\teni U\n.\\kern1.09026\n.\\vbox(4"
        ".01942+1.3611)x4.30675, shifted -3.62892\n..\\hbox"
        "(4.01942+0.0)x0.0, shifted 0.59087\n...\\sevenrm ^"
        "^V\n..\\kern-3.01389\n..\\hbox(3.01389+1.3611)x4.3"
        "0675\n...\\seveni y\n.\\mathoff\n\n! OK.\n[over]\n"
...
static int test_only_a_character_is_centred(void)
{
    ...
    static const char *const expected[] = {
        ...
        "lue(\\parfillskip) 0.0 plus 1.0fil\n..\\glue(\\rig"
        "htskip) 0.0\n.\\penalty 10000\n.\\glue(\\abovedisp"
        "layshortskip) 1.0 plus 3.0\n.\\glue(\\baselineskip"
        ") 6.16667\n.\\hbox(5.83333+1.94444)x111.5995, shif"
        "ted 88.4005\n..\\hbox(5.83333+1.94444)x23.199, dis"
        "play\n...\\teni x\n...\\glue(\\medmuskip) 2.22217 "
        "plus 1.11108 minus 2.22217\n...\\tenrm +\n...\\glu"
        "e(\\medmuskip) 2.22217 plus 1.11108 minus 2.22217"
        "\n...\\teni y\n...\\kern0.35878\n..\\kern83.3102\n"
...
static int test_superscripts_in_display_style(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[t]\n> \\box0=\n\\hbox(8"
        ".49002+2.47217)x10.05292\n.\\mathon\n.\\teni x\n."
        "\\vbox(10.96219+0.0)x4.33765, shifted 2.47217\n.."
        "\\hbox(4.8611+0.0)x3.51666\n...\\seveni b\n..\\ker"
        "n3.0872\n..\\hbox(3.01389+0.0)x4.33765\n...\\seven"
        "i a\n.\\mathoff\n\n! OK.\n[d]\n> \\box0=\n\\hbox(8"
        ".99002+2.47217)x10.05292\n.\\mathon\n.\\teni x\n."
        "\\vbox(11.46219+0.0)x4.33765, shifted 2.47217\n.."
        "\\hbox(4.8611+0.0)x3.51666\n...\\seveni b\n..\\ker"
        "n3.5872\n..\\hbox(3.01389+0.0)x4.33765\n...\\seven"
        "i a\n.\\mathoff\n\n! OK.\n[c]\n> \\box0=\n\\hbox(8"
        ".79948+2.47217)x12.47906\n.\\mathon\n.\\teni x\n."
        "\\vbox(11.27165+0.0)x6.7638, shifted 2.47217\n..\\"
        "hbox(5.17056+0.0)x6.7638\n...\\seveni b\n...\\hbox"
        "(2.15277+0.0)x3.24713, shifted -3.01779 []\n..\\ke"
        "rn3.0872\n..\\hbox(3.01389+0.0)x4.33765\n...\\seve"
        "ni a\n.\\mathoff\n\n! OK.\n> \\box254=void\n\n! OK"
        ".\n",
        NULL,
...
static int test_protrusion_into_boxes(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[box]\n> \\box1=\n\\vbox"
        "(7.5+2.5)x100.0\n.\\hbox(7.5+2.5)x100.0, glue set "
        "69.11435fil\n..\\kern-1.17 (left margin)\n..\\hbox"
        "(7.5+2.5)x13.0556 []\n..\\glue(\\spaceskip) 4.0\n."
        ".\\f a\n..\\f a\n..\\f a\n..\\penalty 10000\n..\\g"
        "lue(\\parfillskip) 0.0 plus 1.0fil\n..\\glue(\\rig"
        "htskip) 0.0\n\n! OK.\n[deep]\n> \\box1=\n\\vbox(6."
        "83331+0.0)x100.0\n.\\hbox(6.83331+0.0)x100.0, glue"
        ...
        "lue(\\rightskip) 0.0\n\n! OK.\n[vbox]\n> \\box1=\n"
        "\\vbox(6.83331+0.0)x100.0\n.\\hbox(6.83331+0.0)x10"
        "0.0, glue set 68.22214fil\n..\\vbox(6.83331+0.0)x7"
        ".50002 []\n..\\f x\n..\\glue(\\spaceskip) 4.0\n.."
        "\\f a\n..\\f a\n..\\f a\n..\\penalty 10000\n..\\gl"
        "ue(\\parfillskip) 0.0 plus 1.0fil\n..\\glue(\\righ"
        "tskip) 0.0\n\n! OK.\n[end]\n> \\box1=\n\\vbox(7.5+"
        "2.5)x100.0\n.\\hbox(7.5+2.5)x100.0, glue set 67.30"
        "879fil\n..\\f a\n..\\f a\n..\\f a\n..\\glue(\\spac"
...
static int test_breaking_inside_a_ligature(void)
{
    ...
    static const char *const expected[] = {
        ...
        "hbox(6.94444+0.0)x300.0, glue set 256.8332fil\n.."
        "\\f x\n..\\f x\n..\\glue(\\spaceskip) 4.0\n..\\f a"
        "\n..\\discretionary\n...\\f -\n..\\discretionary r"
        "eplacing 1\n...\\f f\n...\\f -\n..|\\f f\n..\\f ^^"
        "K (ligature ff)\n..\\f a\n..\\f b\n..\\f l\n..\\f "
...
static int test_protrusion_of_a_negative_code(void)
{
    ...
    static const char *const expected[] = {
        "> \\box254=void\n\n! OK.\n[neg]\n> \\box1=\n\\vbox"
        "(6.83331+0.0)x40.0\n.\\hbox(6.83331+0.0)x40.0, glu"
        "e set 25.37665fil\n..\\kern0.01999 (left margin)\n"
        "..\\f A\n..\\f B\n..\\penalty 10000\n..\\kern0.019"
        "99 (right margin)\n..\\glue(\\parfillskip) 0.0 plu"
        "s 1.0fil\n..\\glue(\\rightskip) 0.0\n\n! OK.\n[pos"
        "]\n> \\box1=\n\\vbox(6.83331+0.0)x40.0\n.\\hbox(6."
        "83331+0.0)x40.0, glue set 25.17888fil\n..\\kern-0."
        "02 (left margin)\n..\\f C\n..\\f D\n..\\penalty 10"
        "000\n..\\kern-0.02 (right margin)\n..\\glue(\\parf"
        "illskip) 0.0 plus 1.0fil\n..\\glue(\\rightskip) 0."
        "0\n\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
...
static int test_the_final_break_is_hyphenated(void)
{
    ...
    static const char *const expected[] = {
        ...
        "eskip) 7.69446\n.\\hbox(4.30554+0.0)x28.0, glue se"
        "t 0.33331 []\n.\\glue(\\baselineskip) 7.69446\n.\\"
        "hbox(4.30554+0.0)x28.0, glue set 22.99998fil []\n"
        "\n! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
...
static int test_hyphenation(void)
{
    ...
    static const char *const expected[] = {
        ...
        "10000\n..\\glue(\\parfillskip) 0.0 plus 1.0fil\n.."
        "\\glue(\\rightskip) 0.0\n\n! OK.\n> \\box0=\n\\vbo"
        "x(6.83331+0.0)x200.0\n.\\hbox(6.83331+0.0)x200.0, "
        "glue set 154.611fil\n..\\f x\n..\\f x\n..\\glue(\\"
        "spaceskip) 4.0\n..\\f A\n..\\discretionary replaci"
        "ng 2\n...\\f n\n...\\f -\n..\\f n\n..\\kern-0.2777"
        "9\n..\\f t\n..\\f a\n..\\f n\n..\\kern-0.27779\n.."
        "\\f t\n..\\penalty 10000\n..\\glue(\\parfillskip) "
        "0.0 plus 1.0fil\n..\\glue(\\rightskip) 0.0\n\n! OK"
        ".\n> \\box0=\n\\vbox(6.15079+0.0)x200.0\n.\\hbox(6"
        ".15079+0.0)x200.0, glue set 153.72212fil\n..\\f x"
        "\n..\\f x\n..\\glue(\\spaceskip) 4.0\n..\\f s\n.."
        "\\f e\n..\\f n\n..\\kern-0.27779\n..\\f t\n..\\f a"
        "\n..\\f n\n..\\kern-0.27779\n..\\f t\n..\\penalty "
        "10000\n..\\glue(\\parfillskip) 0.0 plus 1.0fil\n.."
...
static int test_interword_glue(void)
{
    ...
    static const char *const expected[] = {
        ...
        "e(\\xspaceskip) 9.0 plus 3.0\n.\\f a\n\n! OK.\n> "
        "\\box0=\n\\hbox(4.30554+1.94444)x16.77782\n.\\f a"
        "\n.\\f ,\n.\\glue 4.0 plus 1.25 minus 1.59999\n.\\"
        "f a\n\n! OK.\n> \\box0=\n\\hbox(4.30554+0.0)x17.88"
        "893\n.\\f a\n.\\f .\n.\\glue 5.11111 plus 3.0 minu"
        "s 0.66666\n.\\f a\n\n! OK.\n> \\box0=\n\\hbox(4.30"
        "554+0.0)x13.33336\n.\\f a\n.\\glue 3.33333 plus 1."
        "66666 minus 1.11111\n.\\f a\n\n! OK.\n> \\box0=\n"
        "\\hbox(4.30554+0.0)x17.22226\n.\\f a\n.\\f .\n.\\g"
        "lue 4.44444 plus 4.99997 minus 0.37036\n.\\f a\n\n"
        "! OK.\n> \\box254=void\n\n! OK.\n",
        NULL,
    };
...
static int test_the_current_font_is_grouped(void)
{
    ...
    static const char *const expected[] = {
        ...
        "f i\n\n! OK.\n> \\box0=\n\\hbox(13.66664+0.0)x30.0"
        "0006\n.\\f A\n.\\g A\n.\\f A\n\n! OK.\n> \\box0=\n"
        "\\hbox(13.66664+0.0)x15.00003\n.\\g A\n\n! OK.\n[e"
        "m 10.00002pt] [em 10.00002pt] [em 20.00005pt]\n> "
        "\\box254=void\n\n! OK.\n",
        NULL,
    };
    return run_document_parts(source, expected);
